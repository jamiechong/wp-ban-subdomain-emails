...
Prevent people from registering with emails that contain a subdomain
...
There is no configuration and no setup. It simply just works. The plugin does log all blocked registrations so you can find potential false-positives. 
